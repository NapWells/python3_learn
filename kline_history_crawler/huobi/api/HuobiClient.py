...
# 批量获取最近成交记录
def get_history_trade(symbol, size=1):
    params = {
        'symbol': symbol,
        'size': size
    }
    url = Utils.MARKET_URL + '/market/history/trade'
    return Utils.http_get_request(url, params)
...
def get_tickers():
    ...
    """
    params = {}
    url = Utils.MARKET_URL + '/market/tickers'
    return Utils.http_get_request(url, params)
...
def get_currencies():
    ...
    """
    params = {}
    url = Utils.MARKET_URL + '/v1/common/currencys'
...
def get_trading_assets():
    ...
    """
    params = {}
    url = Utils.MARKET_URL + '/v1/common/symbols'
...
#     print(get_kline('btcusdt','15min',2000))
