...
#     for stock in g.buy_stock:
#     # 个股止损
#         if conduct_accumulate_stopwin(context, data, stock, 0.3) or conduct_accumulate_stoploss(context, data, stock, -0.1):
#             return
#     # 计算AO，AC指标
#     AC_index(stock)
#     # 空仓时，寻找机会入场
...
#     if is_up_going(g.AO_index[stock], 5) and is_up_going(g.AC_index[stock], 3) and is_up_going(close_price[stock], 2):
